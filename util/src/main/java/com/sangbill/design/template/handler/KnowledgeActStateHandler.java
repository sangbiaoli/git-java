...
import com.sangbill.design.template.enumdef.act.KnowledgeActState;
import com.sangbill.util.DateUtil;

@Component
public class KnowledgeActStateHandler extends AbstactActStateHandler{

	
	public KnowledgeActStateHandler() {
		super(KnowledgeActState.ENUMMAP);
	}
